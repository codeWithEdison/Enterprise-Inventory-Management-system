        ...
        <Route path="/" element={<ProtectedRoute><MainLayout /></ProtectedRoute>}>
          ...
          <Route path="inventory">
            ...
            <Route path="stock-in" element={
              <StockKeeperRoute><StockInPage /></StockKeeperRoute>
            } />
            <Route path="stock-out" element={
              <StockKeeperRoute><StockOutPage /></StockKeeperRoute>
            } />
            <Route path="transfer" element={
              <StockKeeperRoute><StockTransferPage /></StockKeeperRoute>
            } />
            <Route path="adjustments" element={
              <StockKeeperRoute><StockAdjustmentsPage /></StockKeeperRoute>
            } />
          </Route>
          ...
          <Route path="requests">
            ...
            <Route path="new" element={
              (isNurse || isHod) ? <NewRequestPage /> : <Navigate to="/requests" replace />
            } />
            <Route path="approve" element={
              (isHod || isAdmin) ? <PendingApprovalsPage /> : <Navigate to="/requests" replace />
            } />
          ...
          <Route path="reports">
            ...
            {/* <Route path="users" element={
              isAdmin ? <UserReportPage /> : <Navigate to="/reports" replace />
            } /> */}
          </Route>
